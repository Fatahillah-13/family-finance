...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\laravel\family-finance\public\storage' => 'string',
            ...
            'services.google_vision.project' => 'string',
            'services.google_vision.key' => 'string',
...
'filesystems.disks.s3.report','filesystems.disks.private.driver','filesystems.disks.private.root','filesystems.disks.private.throw','filesystems.disks.private.report',
'filesystems.links.D:\\laravel\\family-finance\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'services.google_vision.project','services.google_vision.key','services.openai.key','services.openai.model','session.driver',
...
'web','api',);
        registerArgumentsSet('routes', 'auth.google.redirect','auth.google.callback','dashboard',
'budgets.index','budgets.store','budgets.update','budgets.toggle','reports.monthly',
'accounts.index','accounts.store','accounts.update','accounts.toggle','categories.index',
'categories.store','categories.update','categories.toggle','tags.index','tags.store',
'tags.update','tags.toggle','transactions.index','transactions.data','transactions.create',
'transactions.store','transactions.edit','transactions.update','transactions.destroy','transactions.attachments.delete',
'transactions.attachments.download','roles.index','roles.store','roles.update','roles.toggle',
'roles.permissions.sync','households.members.role.update','imports.create','imports.store','imports.preview',
'imports.commit','audit.index','profile.edit','profile.update','profile.destroy',
'households.index','households.store','households.switch','households.members','households.members.destroy',
'households.invitations.store','invitations.show','invitations.accept','invitations.reject','transactions.scan-receipt',
...
'accounts.index','audit.index','auth.confirm-password','auth.forgot-password','auth.login',
'auth.register','auth.reset-password','auth.verify-email','budgets.index','categories.index',
...
'components.responsive-nav-link','components.secondary-button','components.text-input','dashboard','households.index',
'households.members','imports.create','imports.preview','invitations.show','layouts.app',
'layouts.guest','layouts.navigation','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','reports.monthly','roles.index','tags.index','transactions.create',
'transactions.edit','transactions.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'D:.laravel.family-finance.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT_URI','MAIL_MAILER','MAIL_SCHEME','MAIL_HOST',
...
'GOOGLE_CLOUD_PROJECT','GOOGLE_CLOUD_VISION_API_KEY','OPENAI_API_KEY','OPENAI_MODEL','VITE_APP_NAME',);
